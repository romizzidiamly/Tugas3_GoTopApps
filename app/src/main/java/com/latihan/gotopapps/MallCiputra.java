...
public class MallCiputra extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                String notelp = "tel:0761 868888";
                a = new Intent(Intent.ACTION_DIAL, Uri.parse(notelp));

            }else if (pilihan.equals("SMS Center")) {
                String smsteks = "Halo, This is Call Center Mall Ciputra Seraya";
                a = new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("sms:081266669999"));
                a.putExtra("sms_body", smsteks);

            }else if (pilihan.equals("Driving Direction")) {
                String lokasirs = "https://www.google.com/maps/place/Mal+Ciputra+Seraya/@0.5342115,101.4309075,15.83z/data=!4m8!1m2!2m1!1smandiri!3m4!1s0x31d5ab161918e709:0xbdfa90dde03f63ed!8m2!3d0.5359834!4d101.4306173";
